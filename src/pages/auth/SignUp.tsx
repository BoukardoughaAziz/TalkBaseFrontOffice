                      ...
                      <div className="col-xxl-5 col-xl-7 col-lg-8 col-sm-10 mx-auto">
                        <div className="text-center mb-7">
                          <a className="navbar-brand me-0" href="/">
                            <img className="brand-img d-inline-block" src="https://res.cloudinary.com/derpsow86/image/upload/v1760315195/TalkBase-Logo-NO-BG_cloahh.png" alt="brand" style={{ height: "100px" }} />
                          </a>
                        </div>
